      ...
      <div>
        ...
        <section>
          <ul className="flex flex-col gap-[0.4rem]">
            <li>Here's what I'm <a href="https://www.goodreads.com/review/list/188253527?shelf=currently-reading" className="blue-link" target="_blank" rel="noopener noreferrer">reading</a>,  <a href="https://open.spotify.com/playlist/37i9dQZEVXd2oT1sIgz2rt?si=a576c2c08ba74180" className="blue-link" target="_blank" rel="noopener noreferrer">listening to</a>, and <a href="https://boardgamegeek.com/collection/user/mjjiang" className="blue-link" target="_blank" rel="noopener noreferrer">playing</a>.</li>
